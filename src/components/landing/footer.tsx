      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-slate-500 mb-4">
              Enterprise AI automation for modern communities.
            </p>
            <div className="flex gap-3">
              <a href="#" className="p-2 rounded-lg glass hover:bg-white/10 transition-colors" aria-label="Twitter">
              ...
              <a href="#" className="p-2 rounded-lg glass hover:bg-white/10 transition-colors" aria-label="GitHub">
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-xs text-slate-600">
            Built with intelligence. Designed for the future.
          </p>
        </div>
      </div>
    </footer>
